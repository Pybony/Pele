 ...
 * @author lksbr
 */
public class JdBuscaCategoriaUm extends javax.swing.JDialog {

    private String idRetorno;

    public JdBuscaCategoriaUm() {
        setTitle("JdBuscaCategoriaUm - Busca CategoriaUm - v1.00.00");
        initComponents();
        setResizable(false);
        CategoriaUmDao.popularTabela(jtBusca, jtDescricaoDe.getText(), jtDescricaoAte.getText());
    }
