 ...
 * @author lksbr
 */
public class JdBuscaOrigem extends javax.swing.JDialog {

    private String idRetorno;

    public JdBuscaOrigem() {
        setTitle("JdBuscaOrigem - Busca Origem - v1.00.00");
        initComponents();
        setResizable(false);
        OrigemDao.popularTabela(jtBusca, jtDescricaoDe.getText(), jtDescricaoAte.getText());
    }
