 ...
 * @author lksbr
 */
public class JdBuscaPrioridade extends javax.swing.JDialog {

    private String idRetorno;

    public JdBuscaPrioridade() {
        setTitle("JdBuscaPrioridade - Busca Prioridade - v1.00.00");
        initComponents();
        setResizable(false);
        PrioridadeDao.popularTabela(jtBusca, jtDescricaoDe.getText(), jtDescricaoAte.getText());
    }
