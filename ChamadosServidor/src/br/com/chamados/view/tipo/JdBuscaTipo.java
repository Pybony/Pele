 ...
 * @author lksbr
 */
public class JdBuscaTipo extends javax.swing.JDialog {

    private String idRetorno;

    public JdBuscaTipo() {
        setTitle("JdBuscaTipo - Busca Tipo - v1.00.00");
        initComponents();
        setResizable(false);
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        TipoDao.popularTabela(jtBusca, jtDescricaoDe.getText(), jtDescricaoAte.getText());
