 ...
 * @author lksbr
 */
public class JdBuscaSituacao extends javax.swing.JDialog {

    private String idRetorno;

    public JdBuscaSituacao() {
        setTitle("JdBuscaSituacao - Busca Situação - v1.00.00");
        initComponents();
        setResizable(false);
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        SituacaoDao.popularTabela(jtBusca, jtDescricaoDe.getText(), jtDescricaoAte.getText());
