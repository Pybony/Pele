 ...
 * @author Jonas C. Rosa
 */
public class IfPessoa extends javax.swing.JDialog {

    /**
     * Creates new form IfPessoa
     */
    private Logger logger = Logger.getLogger(LogChamados.class);
    private int pessoaId;
    private Pessoa pessoa;
    private JFPessoa telaPessoa;
    
    public IfPessoa() {
        initComponents();
        PessoaDao.popularTabela(JtBusca, null);
        EstadoDao.preencherCombo(JcbBEstado);
    }
    
    public IfPessoa(JFPessoa telaPessoa) {
        initComponents();
        PessoaDao.popularTabela(JtBusca, null);
        EstadoDao.preencherCombo(JcbBEstado);
    ...
    private void initComponents() {
        ...
        JtfBcpf = new javax.swing.JTextField();
                    ...
                    .addGroup(JpBuscaLayout.createSequentialGroup()
                        ...
                        .addGroup(JpBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(JpBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(JtfBcpf, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
        ...
        JpBuscaLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JpBuscaLayout.createSequentialGroup()
                ...
                .addGroup(JpBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(JtfBcpf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(JpBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void JbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbBuscarActionPerformed
        ...
        pessoa.setNome(JtfBNome.getText());
        pessoa.setCpf(JtfBcpf.getText());
        Cidade cidade = new Cidade();
        cidade.setId(((ItemCombo)JcbBCidade.getSelectedItem()).getCodigo());
        pessoa.setCidade(cidade);
        PessoaDao.popularTabela(JtBusca, pessoa);
    ...
    private void selecionarPessoa() {
        ...
        pessoaId = (int) JtBusca.getValueAt(JtBusca.getSelectedRow(), 0);
        Pessoa pessoaB = new Pessoa();
        pessoaB.setId(pessoaId);
        
        pessoa = PessoaDao.obterPessoa(pessoaB).get(0);
        
        this.telaPessoa.setFormPessoa(pessoa);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IfPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField JtfBcpf;
